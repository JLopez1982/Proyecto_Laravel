...
<div class="card m-3" style="width: 18rem;">
    ...
    @if ($product->image)
      <img src="{{ asset("/storage/".$product->image) }}" class="card-img-top" width="200" height="200" alt=".....">
    @else
      <img src="https://placehold.co/600x400" class="card-img-top" width="200" height="200" alt=".....">
    @endif
    ...
    <div class="card-body">
      ...
      <form id="deleteProductForm"
        ...
        method="POST"
        onsubmit="return fnc_confirmar_eliminar_productos();">
        @csrf
        @method('DELETE')
      </form>
      <div class="row">
